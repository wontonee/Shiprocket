...
Route::group(['middleware' => ['web', 'admin'], 'prefix' => 'admin/shiprocket'], function () {
  Route::get('/', [ShiprocketController::class, 'index'])->name('admin.shiprocket.index');

  Route::get('settings', [ShiprocketController::class, 'settings'])->name('admin.shiprocket.settings');
  Route::post('settings', [ShiprocketController::class, 'saveSettings'])->name('admin.shiprocket.settings.save');
  ...
  Route::get('shipment', [ShiprocketController::class, 'shipment'])->name('admin.shiprocket.shipment');
